...
<head>
    ...
    <title>Search Previous admission form</title>
    <style>
    ...
    <!-- php code -->
     ...
     include 'server.php';
        if(isset($_POST['submitroll'])){
            $roll_input=$_POST['roll'];
           $roll_q="select beforeroll from admission where beforeroll=$roll_input";
           $roll_query=mysqli_query($con,$roll_q);
           if(mysqli_num_rows($roll_query)>0){
            $search_query="select * from admission where beforeroll=$roll_input";
            $serch_q_con=mysqli_query($con,$search_query);
            $data=mysqli_fetch_assoc($serch_q_con);

            $enname = $data['studentnameng'];
            $bnname = $data['studentnamebn'];
            $numbirthcer = $data['birthcertificate'];
            ...
            $myincome = $data['motherincome'];
            $mmnum = $data['mothernumber'];
            $absens = $data['guardian'];
            $nationality = $data['nationality'];
            $email = $data['email'];
            $stunumber = $data['studentmobile'];
            $religion = $data['religion'];
            $blood = $data['bloodgroup'];
            $adtype = $data['typead'];
            $prediv = $data['presentdiv'];
            $predist = $data['presentdist'];
            $preupa = $data['presentupa'];
            $premiuni = $data['presentpourosova'];
            $prepara = $data['presentvillage'];
            $perdiv = $data['permanentdiv'];
            $perdist = $data['permanentdist'];
            $perupa = $data['permanentupa'];
            $permiuni = $data['permanentpourosova'];
            $perpara = $data['permanentvillage'];
            $befexam = $data['beforeexam'];
            $befgroup = $data['beforegroup'];
            $beftrade = $data['beforetrade'];
            $befpassyear = $data['beforeexamyear'];
            $befresult = $data['beforeresult'];
            $befschool = $data['beforeschool'];
            $befroll = $data['beforeroll'];
            $preins = $data['institute'];
            $pretcode = $data['tradecode'];
            $predept = $data['dept'];
            $presem = $data['semester'];
            $preshift = $data['shift'];
            $preroll = $data['roll'];
            $upload_path = $data['picture'];
            ...
            ?>
            <script>
                alert("Your entered roll number is wrong.");
            </script>
            <?php
           }
...
>>>>>>> bf687ed240256a9b2df6fbf25f536c6eadeb2da5
</html>